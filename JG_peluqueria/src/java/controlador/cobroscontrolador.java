 ...
 * @author manu_
 */
@WebServlet(name = "cobroscontrolador", urlPatterns = {"/cobroscontrolador"})
public class cobroscontrolador extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action != null) {
            if (action.equalsIgnoreCase("home")) {
                ...
                acceso = "vistas/guardarcobros.jsp";
