                        ...
                        <div class="card-body">
                            <form action="facturacontrolador" method="post">
                                 <%  facturaventamodelo facturaModelo = new facturaventamodelo();
                                    String ultimoNumeroFacturaPago = facturaModelo.obtenerUltimoNumeroFactura();
                                        ...
                                        <div class="container-form">
                                            <table class="table table-striped text-center">
                                                <tbody>
                                                    ...
                                                    <tr class="table-dark">
                                                        <td>FECHA</td>
                                                        <td><input type="text" class="form-control" id="txtfecha" name="txtfechafac" readonly></td>
                                                    </tr>
                                                    <tr class="table-dark">
                                                        <td>ESTADO</td>
                                        ...
                                        <div class="container-form">
                                            <table class="table table-striped text-center">
                                                <tbody>
                                                    <tr class="table-dark">
                                                        <td>CODIGO</td>
                                                        <td><input type="text" class="form-control" name="txtcodigocli" id="txtcodigo" readonly></td>
                                ...
                                <div class="container3">
                                    <div class="window2">
                                        <button type="submit" name="accion" value="guardarfactura" class="btn w-20" style="background-color: #014421; border-color: #014421; color: white;">GUARDAR</button>
                                        <a href="facturaventa.jsp" class="btn w-80" style="background-color: #1E81B0; border-color: #1E81B0; color: white;">REGRESAR</a>
                                    </div>
                                </div>
